	...
	public void afterPropertiesSet() throws Exception {
		...
		template
			.execute("CREATE TABLE IF NOT EXISTS USERS(USERNAME VARCHAR(30) NOT NULL PRIMARY KEY,"
	                ...
	                + "CONSTRAINT FK_GUESTBOOKENTRIES FOREIGN KEY(CONTENTID) REFERENCES GUESTBOOKENTRIES(CONTENTID) ON DELETE CASCADE);");
		template
		...
		.execute("CREATE TABLE IF NOT EXISTS TEXTCONTAINERS(MODULEID INTEGER NOT NULL PRIMARY KEY,"
				+"CONSTRAINT FK_PARAGRAPHS FOREIGN KEY(MODULEID) REFERENCES PARAGRAPHS(MODULEID) ON DELETE CASCADE,"
		...
		.execute("CREATE TABLE IF NOT EXISTS GUESTBOOKS(MODULEID INTEGER NOT NULL PRIMARY KEY,"
				+"CONSTRAINT FK_GUESTBOOKENTRIES FOREIGN KEY(MODULEID) REFERENCES GUESTBOOKENTRIES(MODULEID) ON DELETE CASCADE,"
				+"CONSTRAINT FK_MODULES FOREIGN KEY(MODULEID) REFERENCES MODULES(MODULEID));");
		...
		.execute("CREATE TABLE IF NOT EXISTS PAGES(PAGENAME VARCHAR(50) NOT NULL PRIMARY KEY,"
				+"CONSTRAINT FK_LINK FOREIGN KEY(PAGEID) REFERENCES LINKS(PAGEID) ON DELETE CASCADE,"
				+"PAGEID INT NOT NULL,"
				+"CONSTRAINT FK_MODULES FOREIGN KEY(MODULEID) REFERENCES MODULES(MODULEID) ON DELETE CASCADE);");
         ...
         */
        template
        	.execute("INSERT INTO PAGES(PAGENAME, PAGEID) VALUES ('home',0)");
        
        template
        	.execute("INSERT INTO CONTENTS(CONTENTID, CONTENTNAME, CONTENTTYPE) VALUES (0,'homelink', 'link')");
        
        template
        	.execute("INSERT INTO LINKS(LINK, CONTENTID) VALUES ('home',0)");
	}
